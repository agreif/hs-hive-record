...
, yaml, yesod, yesod-auth, yesod-auth-hashdb, yesod-core
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    yesod-auth-hashdb yesod-core yesod-form yesod-static
  ];
  ...
  testHaskellDepends = [
    ...
    template-haskell text time transformers unordered-containers vector
    wai wai-extra wai-logger warp yaml yesod yesod-auth
    yesod-auth-hashdb yesod-core yesod-form yesod-static yesod-test
  ];
  prePatch = "hpack";
  license = "unknown";
