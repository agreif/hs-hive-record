...
context =
  ...
  { bContextCrudModels =
      ...
      , BCrudModel
        ...
        , bCrudModelEditFormDataJsonUrl = Just "getEditInspectionSuccessDataJsonUrl (inspectionHiveId inspection) maybeCurRoute" -- "HiverecR $ HiveDetailPageDataJsonR $ inspectionHiveId inspection"
        ...
        , bCrudModelDeletePostLoadsModel = True
        , bCrudModelAddPostExtraStoreFunc = Just "storeInspectionDateToSession vAddInspection"
        , bCrudModelEditPostExtraStoreFunc = Nothing
